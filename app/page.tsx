    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-end">
          <Image className="" src={'https://ppph.id/assets/img/new-lppph.png'} alt="logo" width={225} height={225} />
          <Image className="mt-[50px]" src={'https://ppph.id/assets/img/bpjph_logo.png'} alt="logo" width={225} height={225} />
        </div>
