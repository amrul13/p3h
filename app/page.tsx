      ...
      <main
        ...
        <section>
          <div className="bg-green-200 rounded-lg p-6 mb-6">
            ...
            <h1 className=" font-regular text-slate-700 md:text-5 text-center">
              Bila dalam sebulan Anda berhasil mendampingi pengajuan sertifikat
              halal dan disetujui oleh Komisi Halal BPJPH sebanyak 20 Sertifikat
              Halal maka Anda akan mendapatkan penghasilan sebesar :
            </h1>
            <div className="bg-blue-200 text-blue-800 text-lg font-medium me-2 my-2 px-2.5 py-0.5 rounded border-blue-400 text-center">
              Rp. 150.000,- x 20 Sertifikat Halal = Rp. 3.000.000,-
            </div>
            <h1 className=" font-regular text-slate-700 md:text-5 text-center">
              Bagaimana bila Anda berhasil mendapat persetujuan bagi 50
              Sertifikat Halal atau 100 Sertifikat Halal per bulannya?
              Penghasilan Anda dapat mencapai belasan bahkan puluhan juta
              sebulan.{" "}
            </h1>
          </div>
        </section>
        ...
        <section>
          <div className="bg-green-200 rounded-lg p-6 mb-6">
            ...
            <h1 className=" font-regular text-slate-700 md:text-5 text-center">
              Silahkan mengisi Data Anda melalui Form di bawah ini untuk
              mengikuti Pelatihan PPPH dari LPPPH EWI dan Asesmen Penempatan
              Kerja di SWAKARTA
            </h1>
            <div className="mx-12">
              <div className="bg-amber-100 text-amber-500 font-regular my-2 px-2.5 py-0.5 rounded border-blue-400 text-center">
                SILAHKAN MEMINTA LINK KODE REFERRAL UNTUK MELAKUKAN PENDAFTARAN
                PPPH EWI
              </div>
            </div>
            ...
            <form className="" action="#">
              <div className="w-full space-y-6 p-4  my-6 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 ">
                ...
                <span className="text-sm">
                  Seluruh data akan dikirim ke sistem BPJPH
                </span>
              ...
              <div className="w-full space-y-6 p-4  mb-6 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 ">
                ...
                <span className="text-sm">
                  Anda dapat mengisi dengan area kerja Anda sebagai PPPH di
                  provinsi yang berbeda dengan alamat KTP Anda
                </span>
                <div className="grid gap-6 mb-6 lg:grid-cols-2">
                  <div>
                    <label
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="email"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                      placeholder="jl. jalan nomor 123"
                      required
                    />
                  </div>
                </div>
              ...
              <button
                type="submit"
                className="w-full text-white bg-indigo-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Kirim
              </button>
            </form>
